<?php //Só da para utilizar o use, quando está na mesma pasta
...
require_once("/strtec/Controller/MenssagemBot.php");
require_once("/strtec/Controller/Boot.php");
require_once("/strtec/Controller/Menu.php");
require_once("/strtec/Controller/Opcoes.php");
//Como está separada do body, toda alteração tem que incrementar a classe
?>
<!DOCTYPE html>
<!--
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <!-- Logo -->
    <a href="/res/index2.html" class="logo">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="/Boot.php"><i class="fa fa-link"></i> <span>Robo Painel</span></a></li>
        <li><a href="/"><i class="fa fa-link"></i> <span>Conversas</span></a></li>
      </ul>
      <!-- /.sidebar-menu -->
    </section>
    <!-- /.sidebar -->
