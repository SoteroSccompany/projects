...
namespace SituaçãoDeAprendizagem
{
    class ClassAcessoBD
    {
        ...
        private string database = "dbSituacaoDeAprendizagem"; //nome do database
        ...
        public void ExecutarComandosSql(string comandoSql)
        {
            ...
            //"UPDATE Usuario  SET nome = '',telefone ='',cpf = '',email = '',loginn = '', senha ='',tipoUsuario = 0 WHERE codUSer =  0 "
        }
